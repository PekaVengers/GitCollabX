      ...
      <form method='post'>
        ...
        <div className="row">
          <div className="col-50">
            ...
            <label htmlFor="fname"><BsPersonCircle/> Full Name</label>
            ...
            <div className="row">
              <div className="col-50">
                ...
                <input type="text" id="state" name="state" placeholder="State or UT"/>
              </div>
              <div className="col-50">
          ...
          <div className="col-50">
            ...
            <input type="text" id="cname" name="amount" placeholder="$ 0.0"/>
            <label htmlFor="ccnum">Credit card number</label>
            <input type="text" id="cname" name="cardname" placeholder="Card Number" />
            <label htmlFor="ccnum">Description</label>
            <input type="text" id="ccnum" name="cardnumber" placeholder="Description" />
